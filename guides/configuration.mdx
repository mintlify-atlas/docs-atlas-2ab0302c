...
description: "Silo reads silo.toml, SILO_* environment variables, and CLI flags. Every key is optional. Run silo init to generate the file with all defaults annotated."
---
