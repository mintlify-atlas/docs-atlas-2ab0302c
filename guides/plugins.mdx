...
description: "A Silo plugin is a directory of TypeScript files that Silo loads and transpiles. Plugins can hook into entry lifecycle events, serve HTTP routes, and ship admin panels."
---
