...
description: "All six Silo plugin hooks: payloads, mutation rules, delivery semantics, claim format, dispatch order, and error handling for entry and collection events."
---
